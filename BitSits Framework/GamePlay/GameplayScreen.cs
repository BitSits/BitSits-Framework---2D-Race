...
namespace BitSits_Framework
{
    ...
    class GameplayScreen : GameScreen
    {
        ...
        private void LoadNextLevel()
        {
            ...
            // Load the level.
            level = new Level(ScreenManager.GameContent, levelIndex); ++levelIndex;
            load = true;
        }
        ...
        private void DrawScore(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(ScreenManager.GameContent.debugFont,
                "fps : " + fps.ToString("00"), Vector2.Zero, Color.White);
