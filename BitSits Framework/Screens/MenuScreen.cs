...
namespace BitSits_Framework
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public override void HandleInput(InputState input)
        {
            ...
            Point mousePos = new Point(input.CurrentMouseState[0].X, input.CurrentMouseState[0].Y);
            for (int i = 0; i < menuEntries.Count; i++)
            {
                if (menuEntries[i].BoundingRectangle(this).Contains(mousePos))
                {
                    mouseOver = true;
                    selectedEntry = i;
                }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (titleTexture == null)
                spriteBatch.DrawString(ScreenManager.GameContent.debugFont, menuTitle, titlePosition,
